      ...
      >
        ...
        <div className="relative z-10">
          ...
          <blockquote className="relative">
            <p className="text-white/90 text-xl md:text-2xl font-medium leading-[1.4] tracking-tight font-sans italic">
              "{testimonial.quote}"
            </p>
            
            <div className="flex items-center gap-2 mt-4 font-display">
              <div className="h-px w-8 bg-emerald-500/50" />
              <Zap className="w-4 h-4 text-emerald-400 animate-pulse" />
              <p className="text-emerald-400/90 text-[10px] font-bold tracking-[0.2em] uppercase">
        ...
        <div className="relative z-10 mt-auto pt-8 border-t border-white/5 font-display">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-0.5">
                <div className="flex items-center gap-1.5">
                  <span className="text-white font-bold text-base tracking-tight leading-none">{testimonial.name}</span>
                  <Award className="w-4 h-4 text-amber-400/80" />
                </div>
                <div className="flex flex-wrap items-center gap-x-2 gap-y-0.5">
                  <span className="text-white/40 text-[10px] font-bold uppercase tracking-widest">{testimonial.title}</span>
                  <span className="text-white/20 text-xs">•</span>
                  <span className="text-emerald-400/80 text-[10px] font-black uppercase tracking-wider">{testimonial.company}</span>
                </div>
              </div>
            </div>
